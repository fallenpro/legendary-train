...
task.spawn(function()
	...
	plr = game:GetService'Players'.LocalPlayer; plrs = plr.Parent
	plrw = plr.Character or plr.CharacterAdded:Wait()
	plrh = plrw:FindFirstChild('Humanoid') or plrw:WaitForChild("Humanoid")
	plrhrp = plrw:FindFirstChild('HumanoidRootPart') or plrw:WaitForChild('HumanoidRootPart')
...
do -- Example UI
	...
	local Tab = Window:AddTab("Misc")
		...
		Tab:AddButton("ScriptBlox Script Viewer", function()
			loadstring(game:HttpGetAsync('https://raw.githubusercontent.com/laderite/scripts/main/Cloudscripts.lua'))()
		end)
		Tab:AddLabel("Nullware Hub V3 will lag your game for a couple of seconds. Be pat-")
		Tab:AddLabel("-ient while it loads.")
		Tab:AddButton("Nullware Hub V3", function()
			getgenv().Theme = "Blue"
...
for _, v in next, listfiles("QS\\Autoexec") do
	task.spawn(function() loadfile(v)(prereqs) end)
end
