...
local b = w:CreateFolder("ACSG System Gun Mods")
...
local b = w:CreateFolder("Legends of Speed",{
    TextSize = 25;
    TextColor = Color3.fromRGB(255,255,255);
    BgColor = Color3.fromRGB(0,0,0);
})
...
b:Button("Anomic Revamp", function()
