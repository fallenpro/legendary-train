local old; old = hookmetamethod(game, "__namecall", function(self, ...)
 if getnamecallmethod() == "FireServer" and self.Name == "Equipar" then
  ...
  weapon_properties["BulletPenetration"] = math.huge
  ...
  weapon_properties["BSpeed"] = math.huge
  weapon_properties["ExplosiveHit"] = true
  weapon_properties["ExplosionDamage"] = math.huge
  weapon_properties["ExpRadius"] = 500
